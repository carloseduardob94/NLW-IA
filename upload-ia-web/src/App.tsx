    ...
    <div className="min-h-screen flex flex-col">
      <div className="px-6 py-3 flex items-center justify-between border-b">
        ...
        <div className="flex items-center gap-3">
          ...
          <a href="https://github.com/carloseduardob94" target="_blank">
      ...
      <main className="flex-1 p-6 flex gap-6">
        <div className="flex flex-col flex-1 gap-4">
          ...
          <p className="text-sm text-muted-foreground">Lembre-se: você pode utilizar a variável transcription no seu prompt para adicionar o conteúdo da <code className="text-violet-400">{'transcrição'}</code> do vídeo selecionado.</p>
        </div>
